...
<head>
    ...
    <title>Bảng Điểm Kết Quả</title>
    <link rel="stylesheet" href="../css/index.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../css/table.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        .info-container { background: #fff; padding: 25px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); margin-bottom: 30px; border-left: 5px solid #3b7ddd; }
        ...
        .semester-summary { text-align: right; font-size: 1.1rem; font-weight: bold; margin-top: 15px; padding: 10px; background-color: #f0f4f8; border-radius: 6px; color: #3b7ddd; }
        .main-menu ul li.menu-dropdown { position: relative; }
        .main-menu ul li.menu-dropdown .dropbtn { display: block; padding: 15px 25px; color: white; text-decoration: none; font-weight: bold; transition: background-color 0.2s ease-in-out; border-left: 4px solid transparent; display: flex; justify-content: space-between; align-items: center; }
        ...
        .main-menu ul li.menu-dropdown:hover .dropdown-content { display: block; }
    </style>
</head>
<body>
<div class="dashboard-layout">
            ...
            <ul>
                ...
                <li class="menu-dropdown active">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="diemkq.php" class="active">Điểm kết quả</a>
                    </div>
                </li>
    ...
    <main class="content full-width-content">
        <h1 class="welcome-message">Bảng Điểm Kết Quả</h1>
            ...
            <?php foreach ($grades_by_semester as $semester_name => $grades): ?>
                <?php
                    ...
                    foreach ($grades as $grade) {
                        if (is_numeric($grade['so_tin_chi']) && is_numeric($grade['tongket'])) {
                            $total_credits += (float)$grade['so_tin_chi'];
                            $total_points += (float)$grade['tongket'] * (float)$grade['so_tin_chi'];
                        }
                    }
                    $semester_gpa = ($total_credits > 0) ? ($total_points / $total_credits) : 0;
                ?>
                <div class="semester-group table-container">
                    ...
                    <div class="semester-summary">
                        Điểm trung bình học kỳ: <?php echo number_format($semester_gpa, 2); ?>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
